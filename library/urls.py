...
urlpatterns = [
   ...
   path("edit_add_books/", views.edit_add_books, name="edit_add_books"),
   path("edit_add_books_view/", views.edit_add_books_view, name='edit_add_books_view'),
   path("edit_book_borrowed",views.edit_book_borrowed, name="edit_book_borrowed"),
   path("edit_book_borrowed_view",views.edit_book_borrowed_view, name="edit_book_borrowed_view"),
